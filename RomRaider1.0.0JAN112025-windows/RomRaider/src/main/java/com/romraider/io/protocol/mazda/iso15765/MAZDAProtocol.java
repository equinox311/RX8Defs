...
import com.romraider.io.protocol.ProtocolMazda;
import com.romraider.io.protocol.mazda.iso15765.MAZDAResponseProcessor;
import com.romraider.io.protocol.mazda.iso15765.MAZDAProtocol;
import com.romraider.logger.ecu.comms.manager.PollingState;
import com.romraider.logger.ecu.comms.query.EcuInit;
import com.romraider.logger.ecu.comms.query.MazdaEcuInit;
...
public final class MAZDAProtocol implements ProtocolMazda {
    ...
    public static final byte ECU_INIT_COMMAND = (byte) 0x9;
    public static final byte ECU_INIT_RESPONSE = (byte) 0x49;
    public static final byte ECU_ID_SID = (byte) 0x4;
    public static final byte ECU_ID_CMD = (byte) 0x9;
    ...
    public byte[] constructEcuInitRequest(Module module) {
        ...
        // 000007E010C0
        final byte[] request = buildRequest(
                ECU_INIT_COMMAND, false, new byte[]{(byte) 0x04});
        return request;
    }
    ...
    public byte[] preprocessResponse(
        ...
        return MAZDAResponseProcessor.filterRequestFromResponse(
    ...
    public byte[] parseResponseData(byte[] processedResponse) {
        ...
        return MAZDAResponseProcessor.extractResponseData(processedResponse);
    }

    @Override
    public void checkValidEcuInitResponse(byte[] processedResponse) {
        checkNotNullOrEmpty(processedResponse, "processedResponse");
        MAZDAResponseProcessor.validateResponse(processedResponse);
    }
    ...
    public EcuInit parseEcuInitResponse(byte[] processedResponse) {
        ...
        byte[] calIdBytes = Arrays.copyOf(ecuInitBytes, 16);
        int j = 0;
        ...
        //         ssmEcuInit = new SSMEcuInit(ecuInitBytes, calIdStr);
        //         break;
        //     }
        // }
    ...
    public void validateLoadAddressResponse(byte[] response) {
        ...
        MAZDAResponseProcessor.validateResponse(response);
    }
    ...
    public byte[] checkValidSidPidResponse(byte[] response) {
        ...
        return MAZDAResponseProcessor.extractResponseData(response);
    }
